...
cd /Users/rebecca/sudmant/data/myotis

blastn -query /Users/rebecca/sudmant/analyses/myotis/analysis/reciprocal_best_hits/mMyoAui_seq.fasta -db mMyoCai -out result.txt